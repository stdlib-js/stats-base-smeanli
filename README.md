...
```javascript
smeanli = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-smeanli@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-smeanli/tags). For example,

```javascript
smeanli = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-smeanli@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var smeanli = require( 'path/to/vendor/umd/stats-base-smeanli/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-smeanli@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-base-smeanli.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-base-smeanli

[test-image]: https://github.com/stdlib-js/stats-base-smeanli/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-base-smeanli/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-base-smeanli/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-base-smeanli?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-smeanli.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-base-smeanli/main
...
[branches-url]: https://github.com/stdlib-js/stats-base-smeanli/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-base-smeanli/main/LICENSE
